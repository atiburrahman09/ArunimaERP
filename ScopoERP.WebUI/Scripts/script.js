$(document).ready(function () {
    ...
    $('#purchaseOrderCreateDialogCall, .purchaseOrderEditDialogCall, .purchaseOrderCopyDialogCall').live('click', function (e) {
        DialogShow($(this), e);
    });

    $('#fundingCreateDialogCall, .fundingEditDialogCall').live('click', function (e) {
        DialogShow($(this), e);
    });

    $('#productionStatusCreateDialogCall, .productionStatusEditDialogCall').live('click', function (e) {
        DialogShow($(this), e);
    });

    $('#itemCategoryCreateDialogCall, .itemCategoryEditDialogCall').live('click', function (e) {
        DialogShow($(this), e);
    });
