...
namespace ScopoERP.WebUI.Areas.Accounts.Controllers
{
    public class PurchaseRequisitionInstallmentController : Controller
    {
        ...
        [GridAction]
        public ViewResult GetAllPurchaseRequisitionInstallment()
        {
            ...
            return View(new GridModel(purchaseRequisitionInstallmentVM));
        }
        ...
        {
            return Json(purchaseRequisitionLogic.GetTotalAmount(purchaseRequisitionID), JsonRequestBehavior.AllowGet);
        }
    }
}